    ...
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="p-10 w-80 flex flex-col items-center justify-center py-22 shadow rounded-md">
        ...
        <div className="mt-3 text-center">
          ...
          <p className="leading-5 mt-2 line-hieght text-center text-gray-800">The majestic Rocky Mountains are a major tourist location in the western United States.</p>
        </div>
